...
namespace WebApplication_PrepareTest.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,StudentRollId,StudentDOB,ClassId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,StudentName,StudentRollId,StudentDOB,ClassId")] Student student)
        {
            if (ModelState.IsValid)
            {
